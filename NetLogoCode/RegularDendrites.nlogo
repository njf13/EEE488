...
turtles-own [new? growth-length str]
...
to setup
  ...
  set file-name (word "C:\\Users\\Owner\\Desktop\\4nec2data" time-stamp ".txt")
...
to move
  ; here are the commands to draw the tree
      ...
      ;; add the starting coordinates and wirenumber to the output string
      set str (word "GW " wire-number " 1 " xcor " " ycor " 0 ")
      ...
      ;; add the ending coordinates and the diameter to the output string
      set str (word str xcor " " ycor " 0 " pen-size)
      print str
      if (log-to-file) [
        file-open file-name
        file-print str
